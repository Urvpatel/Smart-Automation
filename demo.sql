...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 06, 2023 at 02:09 PM
...
(46, 'urv', '5', 'new.png', 1),
(45, 'neel', '30', 'pexels-sebastiaan-stam-1097456.jpg', 1);
...
CREATE TABLE IF NOT EXISTS `clnt` (
  `T_id` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `Service_Id` int NOT NULL,
  `Service_date` date NOT NULL,
  `Feedback` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Cost` int NOT NULL
...
(61, 'neel', '30', 'pexels-sebastiaan-stam-1097456.jpg'),
(60, 'urv', '5', 'new.png');
...
CREATE TABLE IF NOT EXISTS `service_book` (
  `id` int NOT NULL AUTO_INCREMENT,
  `U_name` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tech` (
  ...
  `T_address` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `T_email` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `cn_no` int NOT NULL,
  `password` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
