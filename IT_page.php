...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image) || empty($product_quantity)){
      ...
      $insert = "INSERT INTO it(name, price, image, quantity) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity')";
...
<div class="container">
      ...
      <form id="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <select id="myList" class="box">
                           ...
                           <option value="admin_page.php">Add Product To Home Page </option>
									<option value="IT_page.php">IT Products</option>
   ...
   $select = mysqli_query($conn, "SELECT * FROM it");
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="IT_update.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="IT_page.php?delete=<?php echo $row['id']; ?>" class="btn" onclick="return confirm('Are you sure you want to delete');"> <i class="fas fa-trash"></i> delete </a>
