...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $update_data = "UPDATE audio SET name='$product_name', price='$product_price', image='$product_image', quantity=$product_quantity  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <?php
      ...
      $select = mysqli_query($conn, "SELECT * FROM audio WHERE id = '$id'");
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="1" max="100" placeholder="enter quantity" name="product_quantity" class="box">
      <input type="file" id="file"  onchange="return fileValidation()" name="product_image" class="box">
      <input type="submit" value="update product" name="update_product" class="btn">
      <a href="audio_page.php" class="btn">go back!</a>
   </form>
