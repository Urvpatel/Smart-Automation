...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $update_data = "UPDATE acescont SET name='$product_name', price='$product_price', image='$product_image', quantity=$product_quantity  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <?php
      ...
      $select = mysqli_query($conn, "SELECT * FROM acescont WHERE id = '$id'");
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="AC_page.php" class="btn">go back!</a>
   </form>
