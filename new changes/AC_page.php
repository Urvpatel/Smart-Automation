...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image) || empty($product_quantity)){
      ...
      $insert = "INSERT INTO acescont(name, price, image, quantity) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity')";
...
<div class="container">
   ...
   $select = mysqli_query($conn, "SELECT * FROM acescont");
