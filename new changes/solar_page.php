...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image) || empty($product_quantity)){
      ...
      $insert = "INSERT INTO solar(name, price, image, quantity) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity')";
...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM solar WHERE id = $id");
   header('location:solar_page.php');
};
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form id="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         ...
         <select id="myList" class="box">
									...
									<option value="productsbb.php">Add Product To Home Page </option>
   ...
   $select = mysqli_query($conn, "SELECT * FROM solar");
      ...
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               ...
               <a href="solar_page.php?delete=<?php echo $row['id']; ?>" class="btn" onclick="return confirm('Are you sure you want to delete');"> <i class="fas fa-trash"></i> delete </a>
