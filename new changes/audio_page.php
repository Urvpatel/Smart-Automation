...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image) || empty($product_quantity)){
      ...
      $insert = "INSERT INTO audio(name, price, image, quantity) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity')";
...
if(isset($_GET['delete'])){
   $id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM audio WHERE id = $id");
   header('location:audio_page.php');
};
...
<div class="container">
   ...
   $select = mysqli_query($conn, "SELECT * FROM audio");
      ...
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               ...
               <a href="audio_page.php?delete=<?php echo $row['id']; ?>" class="btn" onclick="return confirm('Are you sure you want to delete');"> <i class="fas fa-trash"></i> delete </a>
