...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image) || empty($product_quantity)){
      ...
      $insert = "INSERT INTO auto(name, price, image, quantity) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity')";
...
<div class="container">
   ...
   $select = mysqli_query($conn, "SELECT * FROM auto");
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="auto_update.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="auto_page.php?delete=<?php echo $row['id']; ?>" class="btn" onclick="return confirm('Are you sure you want to delete');"> <i class="fas fa-trash"></i> delete </a>
